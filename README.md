...
Update the first line of `script.js` to get predictions from your own API hosted on GCP (make sure to use `https`, not `http`):

```js
// script.js

let taxiFareApiUrl = 'https://YOUR_API_URL/predict';
```
